...
exports.aesDecrypt = exports.ALIPAY_ALGORITHM_MAPPING = exports.sign = void 0;
...
function parseKey(aesKey) {
    return {
        iv: CryptoJS.enc.Hex.parse((0, lodash_1.padEnd)('', 32, '0')),
...
function sign(method, params = {}, config) {
    ...
    }, (0, lodash_1.omit)(params, ['bizContent', 'needEncrypt']));
